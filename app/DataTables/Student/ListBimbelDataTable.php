...
class ListBimbelDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('status', function ($data) {
                $notRegis = '<span class="badge bg-danger">Tidak Terdaftar</span>';
                $regis = '<span class="badge bg-success">Terdaftar</span>';

                // check status
                $status = StudentOfBimbel::where('user_id', auth()->user()->id)->where('category_bimbel_id', $data->category_bimbel_id)->first();
    ...
    {
        return 'ListBimbel_' . date('YmdHis');
    }
}
